use crate::{
    app_data::AppDataRef,
    error::ServiceResult,
    model::{DailyStatisticsResponse, StatisticsType, User, UserRepository},
};
...
// #[handler]
// async fn get_data(req: &mut Request, depot: &mut Depot) -> ServiceResult<DailyStatisticsResponse> {
...
//     Ok(DailyStatisticsResponse(statistics))
// }
